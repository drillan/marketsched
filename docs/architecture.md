...
| 時間帯 | セッション | `is_trading_hours()` | 境界 |
|--------|-----------|---------------------|------|
| 00:00 - 06:00 | NIGHT（前日分） | `True` | 06:00 を含まない |
| 06:00 - 08:45 | CLOSED | `False` | 06:00 を含む |
| 08:45 - 15:45 | DAY | `True` | 両端含む |
| 15:45超 - 17:00 | CLOSED | `False` | 15:45 を含まない |
| 17:00 - 24:00 | NIGHT | `True` | 17:00 を含む |
